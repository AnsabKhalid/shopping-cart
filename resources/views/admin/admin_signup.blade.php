	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('public/frontend/login/images/bg-01.jpg');">
			<div class="wrap-login100">
				<form class="login100-form validate-form" action="{{ url('/create_admin_account') }}" method="POST">
					{{ csrf_field() }}
                    <a href="{{ url('/admin') }}">
					...
					<!-- @if (Session::has('status'))
					 ...
					 <div class="wrap-input100 validate-input" data-validate = "Enter username">
						<input class="input100" type="text" name="admin_name" placeholder="Enter your Full name">
					...
					<div class="text-center p-t-90">
						<a class="txt1" href="{{ url('/admin_login') }}">
