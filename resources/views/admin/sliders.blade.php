              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    <td>{{ $increment }}</td>
                    <td>
                        <img src="public/storage/slider_image/{{ $slider->slider_image }}" style="height : 50px; width : 50px" class="img-circle elevation-2" alt="User Image">
                    </td>
                    <td>{{ $slider->description1 }}</td>
                    <td>{{ $slider->description2 }}</td>
                    <td>
                      @if ($slider->status == 1)
                          <a href="{{ url('/unactivate_slider/'.$slider->id) }}" class="btn btn-warning">Unactivate</a>
                      @else
                          <a href="{{ url('/activate_slider/'.$slider->id) }}" class="btn btn-success">Activate</a>
                      @endif
