        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-success">
              ...
              @endif
                {!!Form::open(['action' => 
                'App\Http\Controllers\ProductController@saveproduct', 'method' => 'POST', 'enctype' => 'multipart/form-data'])!!} 
                {{ csrf_field() }}
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <!-- <label for="exampleInputEmail1">Product price</label>
                    <input type="number" name="product_price" class="form-control" id="exampleInputEmail1" placeholder="Enter product price" min="1"> -->
                    {{ Form::label('', 'Product Detail', ['for' => 'exampleInputEmail1'] )}}
                    {{ Form::text('detail', '', ['class' => 'form-control', 'id' => 'exampleInputEmail1', 'placeholder' => 'Enter product detail'] )}}
                  </div>
                  <div class="form-group">
                  ...
                  <div class="input-group">
                    <div class="custom-file">
                      ...
                      {{ Form::file('product_image', ['class' => 'form-control', 'id' => 'exampleInputFile'] )}}
