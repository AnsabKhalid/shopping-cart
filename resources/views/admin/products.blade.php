                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>
                        ...
                        <img src="public/storage/product_image/{{ $product->product_image }}" style="height : 50px; width : 50px" class="img-circle elevation-2" alt="User Image">
                    </td>
                    ...
                    <td>
                      @if ($product->status == 1)
                          <a href="{{ url('/unactivate_product/'.$product->id) }}" class="btn btn-warning">Unactivate</a>
                      @else
