                      ...
                      <tr>
                        ...
                        <td>
                          @if ($feedback->status == 1)
                            <a href="{{ url('/unactivate_feedback/'.$feedback->id) }}" class="btn btn-warning">Unactivate</a>
                          @else
                              <a href="{{ url('/activate_feedback/'.$feedback->id) }}" class="btn btn-success">Activate</a>
                          @endif
                            <a href="{{ url('/delete_feedback/'.$feedback->id) }}" id="delete" class="btn btn-danger" ><i class="nav-icon fas fa-trash"></i></a>
                          </td>
                      </tr>
                      {{Form::hidden('', $increment += 1)}}
                    @endforeach
