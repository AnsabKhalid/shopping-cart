<!-- <div class="py-1 bg-primary">
	    		...
	    		<div class="col-lg-12 d-block">
		    		<div class="row d-flex">
		    			<div class="col-md pr-4 d-flex topper align-items-center">
						    ...
						    <span class="text">+92 345-6789761</span>
					    </div>
					    <div class="col-md pr-4 d-flex topper align-items-center">
	...
	?>
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light shadow-lg bg-white rounded" id="ftco-navbar">
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
			  ...
			  @if(Session::has('client'))
			  <li class="nav-item active"><a href="{{ url('/wishlistItems') }}" class="nav-link">Wishlist[{{ $totalWishlist }}]</a></li>
			  @endif
