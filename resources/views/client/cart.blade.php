					...
					@if(Session::has('cart'))
						@foreach($products as $product)
								<tr class="text-center">
									...
									<td class="image-prod"><div class="img" style="background-image:url(public/storage/product_image/{{ $product['product_image'] }});"></div></td>
...
{!!Form::open(['action' => 
'App\Http\Controllers\ClientController@addFeedback', 'method' => 'POST'])!!} 
{{ csrf_field() }}
<div class="card-body">
	<div class="form-group">
	<label for="">Comment</label>
	<input type="text" class="form-control text-left px-3" name="feedback" placeholder="Enter your comment">
	</div>
...
<div class="col-lg-4 mt-5 cart-wrap ftco-animate">
	...
	<p><a href="{{ url('/checkout') }}" class="btn btn-primary py-3 px-4" style="margin-left:65px">Proceed to Checkout</a></p>
</div>
</div>
</div>
</section>
