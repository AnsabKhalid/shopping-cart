    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview {{ request()->is('feedback') ? 'menu-open' : '' }}">
            <a href="#" class="nav-link {{ request()->is('feedback') ? 'active' : '' }}">
              <i class="nav-icon fas fa-folder"></i>
              <p>
              Feedbacks
                <i class="fas fa-angle-left right"></i>
          ...
          <li class="nav-item has-treeview {{ request()->is('admin_accounts_view') ? 'menu-open' : '' }}">
            <a href="#" class="nav-link {{ request()->is('admin_accounts_view') ? 'active' : '' }}">
              <i class="nav-icon fas fa-folder"></i>
              <p>
                Admin_Accounts
                <i class="fas fa-angle-left right"></i>
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ url('/admin_accounts_view') }}" class="nav-link {{ request()->is('admin_accounts_view') ? 'active' : '' }}">
                  <i class="far fa-file nav-icon"></i>
                  <p>Admin_Accounts</p>
                </a>
              </li>
